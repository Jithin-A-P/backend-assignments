...
describe('Shelf Service Tests', () => {
    ...
    describe('Test for getShelfById', () => {
        test('Success case', async () => {
            ...
            when(mockFindById).calledWith(1).mockResolvedValueOnce([{ shelfCode: 'Shelf Code', location: 'Location 1' }])
    ...
    describe('Test for removeShelf', () => {
        test('Success case', async () => {
            const mockFindById = jest.fn();
            when(mockFindById).calledWith(1).mockResolvedValueOnce({ shelfCode: 'Shelf Code', location: 'Location 1', books: [] })
            shelfRepository.findById = mockFindById;
        ...
        test('Failure case where book in shelf', async () => {
            const mockFindById = jest.fn();
            when(mockFindById).calledWith(1).mockResolvedValueOnce({ shelfCode: 'Shelf Code', location: 'Location 1', books: ["Book 1"] })
            shelfRepository.findById = mockFindById;
