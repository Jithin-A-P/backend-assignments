...
export class BookShelfJnTable1692620016235 implements MigrationInterface {
    name = 'BookShelfJnTable1692620016235'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "book_shelf_jn" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "book_count" integer NOT NULL, "shelf_code" character varying NOT NULL, "book_isbn" character varying NOT NULL)`);
        ...
        await queryRunner.query(`ALTER TABLE "book_shelf_jn" ADD CONSTRAINT "PK_8dd16edc762b715de0dbdde6984" PRIMARY KEY ("book_isbn", "id", "shelf_code")`);
