...
export class FirstMigration1692185235806 implements MigrationInterface {
    name = 'FirstMigration1692185235806'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "employee" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "email" character varying NOT NULL, "joining_date" character varying NOT NULL, "password" character varying NOT NULL, "experience" integer NOT NULL DEFAULT '0', "role" character varying NOT NULL DEFAULT 'developer', "status" character varying NOT NULL DEFAULT 'active', "department_id" integer NOT NULL, CONSTRAINT "PK_3c2bc72f03fd5abbbc5ac169498" PRIMARY KEY ("id"))`);
